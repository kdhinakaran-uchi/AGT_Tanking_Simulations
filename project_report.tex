...
The 3-2-1 mechanism's inversion of Tier~A incentives---giving the three worst
teams \emph{fewer} lottery balls---reduces the extreme concentration of bad
outcomes at the very bottom of the lottery, effectively spreading pick quality
more evenly across the weakest teams.
...
A single rational agent does produce positive aggregate tanking (0.2\%), but
...
0.2 percentage points to the aggregate tanking rate, with the all-rational
equilibrium (6.9\%) at the upper end.
